...
<body>
	...
	<div align="center">
	   ...
	   <table border="1" cellspacing="0" width="65%">
	      <tr bgcolor="#ffcc00">
	         <th>상품번호</th> <th>카테고리 코드</th> <th>상 품 명</th>
	      ...
	      <c:if test="${!empty list }">
	         <c:forEach items="${list }" var="dto">
	            <tr>
	               ...
	               <td>
	                  <a href="<%=request.getContextPath() %>/admin_prod_update.do?pnum=${dto.getPnum() }">수 정</a>
	                        &nbsp;&nbsp;|&nbsp;&nbsp;
	                  <a href="<%=request.getContextPath() %>/admin_prod_delete.do?pnum=${dto.getPnum() }">삭 제</a>
	               </td>
	            </tr>
	         </c:forEach>
	      </c:if>
