...
public class UploadDTO {
	...
	public String getUpload_redate() {
		return upload_redate;
	}
	public void setUpload_redate(String upload_redate) {
		this.upload_redate = upload_redate;
	}
